...
["stratosphere","成層圏"],
["the earth's axis","地軸"],
["ITCZ/inter-tropical convergence zone","赤道収束帯(略称/正式名称)"],
...
["Philippine Sea Plate","フィリピン海プレート"],
["aurora","オーロラ"],
["meteor shower","流星群"],
...
["insolation","日射"],
["pore","気孔"],
["UHIE/urban heat island effect","ヒートアイランド現象(略称/正式名称)"],
...
["heatwave","熱波"],
["equatorial","赤道直下の"],
["CTAM/continental tropical air mass","熱帯大陸気団(略称/正式名称)"],
["CPAM/continental polar air mass","寒帯大陸気団(略称/正式名称)"],
["northeasterly trade winds","北東貿易風"],
["southeasterly trade winds","南東貿易風"],
...
["isohyet","等降水量線"],
["scrub","低木"],
["El Niño-Southern Oscillation","エルニーニョ・南方振動"],
["respiration","呼吸"],
["sublimation","昇華"],
["chlorophyll","葉緑素"],
["plankton","プランクトン"],
...
["natural resin","天然樹脂"],
["bauxite","ボーキサイト"],
["export-oriented industrialisation","輸出志向型工業政策"],
["solar farm","太陽光発電所"],
["anvil","鉄床雲"],
...
["steel production","製鉄"],
["coal mining","石炭産出"],
["R&D/research and development","研究と開発(略称/正式名称)"],
["powerhouse","発電所"],
["appliance","家電"],
...
["DTM/demographic transition model","人口転換モデル(略称/正式名称)"],
...
["modernise","近代化する"],
["MEDCs/more economically developed countries","先進国(略称/正式名称)"],
["LEDCs/less economically developed countries","後進国(略称/正式名称)"],
...
["radioactive","放射性のある"],
["CFC/chlorofluorocarbon","フロンガス(略称/正式名称)"],
["bustee","(インドの) スラム"],
["dystrophy","栄養失調"],
["disparity","格差"],
["eutrophication","富栄養化"],
...
["inhospitable","荒れ果てた"],
["secluded","隔絶された"],
["CSR/corporate social responsibility","企業の社会的責任(略称/正式名称)"],
["smallpox","天然痘"],
["apartheid","アパルトヘイト"],
["turbidity","濁り"],
...
["rubbish","廃棄物"],
["PPP/purchasing power parity","購買力平価説(略称/正式名称)"],
["cholera","コレラ"],
["hut","粗末な小屋"],
["uneven","不公平"],
["derelict","遺棄された"],
...
["tariff","関税"],
["dependency","属国"],
["enclave","少数民族集団，飛び地 (１つの外国の領土に完全に取り込まれた自国の領土)"],
["exclave","飛び地 (１つまたは複数の外国の領土に取り込まれた自国の領土)"],
["indicator","経済指標"],
["net export","純輸出"],
["medium","媒体"],
